  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const dispose = (obj: unknown) => {
        ...
        const record = obj as { remove?: () => void; destroy?: () => void }
        if (typeof record.remove === 'function') record.remove()
        else if (typeof record.destroy === 'function') record.destroy()
      }
